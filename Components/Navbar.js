    ...
    return (
        <>
            ...
            <div className="nav-header">
                <Link href="/"><a className="nav-brand static-logo"><img src="assets/img/Datascience.png" className="logo" alt /></a></Link>
                <a className="nav-brand fixed-logo" href="#"><img src="assets/img/Datascience.png" className="logo" alt /></a>
